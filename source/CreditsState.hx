...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Burrito Kitty'],
		['Tahir Toprak Karabekiroglu', '', 'Made the mod', 'https://twitter.com/tahirkarabekir', FlxColor.fromRGB(182, 84, 82)],
		[''],
		['Icon By'],
		['Ralty', '', '', 'https://twitter.com/raltyro', FlxColor.WHITE],
		[''],
		['Colon Three'],
		['Unholywanderer04', '', ':3', 'https://twitter.com/Unholy_wanderer', FlxColor.WHITE],
		[''],
		['Insanity and Dave By'],
		['MoldyGH', '', '', 'https://twitter.com/moldy_gh', FlxColor.fromRGB(37, 43, 255)],
		[''],
		['Original Songs'],
		...
		['Hill Climb Racing', '', 'By Fingersoft Ltd\nThanks for making the best mobile game ever!! :)', 'https://fingersoft.com', FlxColor.WHITE],
		[''],
		['Psych Engine Team'],
