...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		[''],
		['Original Songs'],
		['title.wma', '', 'Composed by Stan LePard', '', FlxColor.WHITE],
		['HOME', '', 'Composed by HOME', '', FlxColor.WHITE],
		['Fireflies', '', 'Composed by Adam Young', '', FlxColor.WHITE],
		['Hold Your Colour', '', 'Composed by Pendulum', '', FlxColor.WHITE],
		[''],
		['Psych Engine Team'],
