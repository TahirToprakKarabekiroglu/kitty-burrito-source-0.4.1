...
**/
class HighSubstate extends FlxGroup 
{
    ...
    public function new()
    {
        ...
        text.borderSize = 2;
        var string:String = "Your strums are higher!\nNot only your strums, you are too!\n\nLuckily, you can hit *HIGHER* notes\nto adjust your strum to where they were.";
        string += "\n\nMissing *HIGHER* notes will give you small /punishment/,\nbut you can recover easily.";
    ...
    override function update(elapsed:Float) 
    {
        ...
        {
            FlxG.save.data.explainedHigh = true;
            FlxG.save.flush();
